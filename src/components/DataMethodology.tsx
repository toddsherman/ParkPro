...
/**
 * Small affordance that used to open the methodology modal. It now scrolls to
 * the permanent #methodology section at the bottom of the page (globals.css
 * sets scroll-behavior: smooth).
 */
...
/**
 * Permanent "Data Sources & Methodology" section rendered at the bottom of
 * the main page (below the calendar and, when dates are selected, below the
 * range results panel).
 */
export default function DataMethodology() {
  return (
    <section
      ...
      className="mt-12 mb-4 scroll-mt-[104px] rounded-xl border border-panel-border bg-white/60 dark:bg-slate-900/40"
    >
      {/* Header */}
      <div className="flex items-center gap-2 px-4 sm:px-5 py-4 border-b border-slate-200 dark:border-slate-700">
      ...
      {/* Body */}
      <div className="px-4 sm:px-5 py-4 grid gap-x-8 gap-y-5 md:grid-cols-2 text-sm text-slate-600 dark:text-slate-300">
        ...
        <section>
          ...
          <div className="mt-2 px-3 py-2 rounded-lg bg-slate-50 dark:bg-slate-800 font-mono text-xs text-slate-700 dark:text-slate-300 overflow-x-auto">
      ...
      {/* Footer */}
      <div className="px-4 sm:px-5 py-3 border-t border-slate-200 dark:border-slate-700 text-center">
