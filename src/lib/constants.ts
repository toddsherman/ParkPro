...
export const MONTHLY_CLIMATE: Record<
  number,
  { highF: number; lowF: number; precipChance: number }
> = {
  1: { highF: 48, lowF: 26, precipChance: 45 },
  2: { highF: 52, lowF: 28, precipChance: 40 },
  3: { highF: 56, lowF: 30, precipChance: 35 },
  4: { highF: 63, lowF: 35, precipChance: 25 },
  5: { highF: 72, lowF: 42, precipChance: 15 },
  6: { highF: 82, lowF: 50, precipChance: 5 },
  7: { highF: 90, lowF: 56, precipChance: 3 },
  8: { highF: 88, lowF: 55, precipChance: 3 },
  9: { highF: 82, lowF: 48, precipChance: 5 },
  10: { highF: 70, lowF: 38, precipChance: 20 },
  11: { highF: 56, lowF: 30, precipChance: 35 },
  12: { highF: 48, lowF: 26, precipChance: 45 },
};
